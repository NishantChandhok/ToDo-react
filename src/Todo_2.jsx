...
const Todo = () => {
    ...
    const addData = () => {
        if (input === '') {
            ...
            setData([...data, { id: small_id, name: input, select: true }]);
        }
        setInput('');
                    ...
                    data.map((element) => {
                        return (
                            ...
                            <div className="individual">
                                {
                                    (element.select) ?
                                        (<div className="ind_text">{element.name}</div>) : (<div className="ind_text"><del>{element.name}</del></div>)
                                }
                                ...
                                <div className="indideButtons">
                                    ...
                                    <button onClick={() => strikeThrough(element)} className="insideButton" title='Strike' >S</button>
                                </div>
